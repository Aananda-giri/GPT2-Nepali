...
litgpt: playground for keepiing up to date wuth llm optimizations
more than 20 llms implementation

inference, fine-tuning, pre-training, 
tiny llama was pretrained with litgpt

ollama: tool for inference 
