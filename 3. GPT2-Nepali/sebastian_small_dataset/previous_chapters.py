...
# Modified
# import tiktoken
from tokenizers import Tokenizer    # requires !pip install tokenizers
...
class GPTDatasetV1(Dataset):
    def __init__(self, txt, tokenizer, max_length, stride):
        ...
        # token_ids = tokenizer.encode(txt, allowed_special={"<|endoftext|>"}).ids
